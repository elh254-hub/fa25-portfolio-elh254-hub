...
technologies:
image: '/assets/images/IMG_5295.jpeg'
---
...
1. **Precisely when and where are grapes partially liquified during the harvest process?**  
   We need to know when liquid is present and the state of the grapes throughout the harvest process to determine the best way to filter SLF out.

2. **Which harvesters and designs are most frequently used in upstate New York?**  
   We need to know harvester designs to determine where in the process to insert our product. Is harvesting and containing done by two different vehicles or trailers, or by one unit?

3. **How willing and able are farmers to implement new technology during harvest?**  
   We need to understand the importance of efficiency, reliability, repairability, durability, and ease of use for growers.

## Client Pitch Sketch

<figure style="text-align: center; margin: 30px auto;">
  <img src="{{ '/assets/images/PosterSketch.jpg' | relative_url }}"
       alt="Preliminary prototype sketch"
       style="max-width: 700px; width: 100%; height: auto;">
  <figcaption style="margin-top: 10px; font-size: 0.95em;">
    Preliminary prototype sketch.
  </figcaption>
</figure>
...
<div style="display: flex; gap: 24px; justify-content: center; flex-wrap: wrap; margin-top: 20px;">
  ...
  <div style="text-align: center; max-width: 400px;">
    <img src="{{ '/assets/images/IMG_4880.jpeg' | relative_url }}"
         alt="Completed functional prototype"
         style="width: 100%; height: auto;">
    <p style="margin-top: 8px;">Completed functional prototype.</p>
  </div>

  <div style="text-align: center; max-width: 400px;">
    <img src="{{ '/assets/images/IMG_5295.jpeg' | relative_url }}"
         alt="Initial design sketch"
         style="width: 100%; height: auto;">
    <p style="margin-top: 8px;">Initial design sketch.</p>
  </div>
